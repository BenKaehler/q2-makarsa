...
function main()
    ...
    @add_arg_table s begin
        ...
        "--conv"
            ...
            default =0.01
        "--feed_forward"
            help = "enable feed-forward heuristic,default = false "
            action = :store_true
        "--max_tests"
        ...
        "--track_rejections"
            ...
            action = :store_true
        "--verbose"
            help = "print progress information, default = false "
            action = :store_true
        "--prec"
            ...
            default = 64
        "--make_sparse"
            help = "use a sparse data representation (should be left at true in almost all cases),default = false "
            action = :store_true 
        "--update_interval"
